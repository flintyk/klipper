...
class PrinterProbe:
    def __init__(self, config, mcu_probe):
        ...
        # self.printer.lookup_object('pins').re_register_chip('probe', self)
    ...
    def _probe(self, speed):
        ...
        # self.gcode.respond_info("zhe li %f, %f, %f" % (pos[0], pos[1], pos[2]))
        try:
    ...
    def run_probe(self, gcmd):
        ...
        # self.gcode.respond_info("zoudaozheli")
        if must_notify_multi_probe:
            self.multi_probe_begin()
        probexy = self.printer.lookup_object('toolhead').get_position()[:2]
        retries = 0
        positions = []
        self.gcode.respond_info("zoudao 175 %f" % (speed,))
...
class ProbeEndstopWrapper:
    ...
    def multi_probe_end(self):
        ...
        self.raise_probe()
        self.multi = 'OFF'
        # self.gcode.respond_info("da yin dao zhe li %s" % (self.multi, ))
